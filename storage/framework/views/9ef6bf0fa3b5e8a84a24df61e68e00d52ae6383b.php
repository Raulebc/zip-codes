        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                ...
                <div class="text-center sm:text-left">
                    ...
                    <p class="text-sm">
                        <a href="<?php echo e(url('/api/zip-codes/01000')); ?>"
                            class="text-blue-400 hover:text-blue-700"
                        >
                            <?php echo e(url('/api/zip-codes/01000')); ?>

                        </a>
                    </p>
                    <p class="text-gray-600 text-sm">
                        The request must contain a query parameter called <code>zip_code</code> with the zip code you
                        want to search.
                    </p>
                    <p class="text-gray-600 text-sm">
                        The response will be a JSON object with the following structure:
                    </p>
<pre class="text-sm bg-gray-100">
...
<?php /**PATH /Users/RaulEBC/Documents/GitHub/zip-codes/resources/views/welcome.blade.php ENDPATH**/ ?>